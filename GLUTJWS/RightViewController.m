...
- (void)viewDidLoad
{
    ...
    UILabel * classLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.view.center.x, self.view.center.y * 0.9, 150, 40)];
    ...
    UILabel * collegeLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.view.center.x * 0.9, self.view.center.y, 170, 40)];
    ...
    //取消按钮
    UIButton * cancel =[[UIButton alloc]initWithFrame:CGRectMake(self.view.center.x * 0.95, self.view.center.y * 5/3.8, 150, 30)];
